...
while($row2=mysqli_fetch_assoc($result))
{
    ...
    echo "Email Id:".$row2['Email']."</td><td>";
...
$result=mysqli_query($conn,$sql);
echo "<table border=1>";
echo "<th><a href=a_dashboard.php?sort=Name>Name</a></th>";
echo "<th><a href=a_dashboard.php?sort=Name>Mobile No</a></th>";
echo "<th><a href=a_dashboard.php?sort=Email>Email</a></th>";
echo "<th><a href=a_dashboard.php?sort=Department>Address</a></th>";
