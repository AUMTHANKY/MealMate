...
{
	echo "hi";
	$q="insert into signup(Name,Mobile_No,Email,Address,Username,Password,Confirm_Password) VALUES ('".$_POST['Name']."','".$_POST['Mobile_No']."','".$_POST['Email']."','".$_POST['Address']."','".$_POST['Username']."','".$_POST['Password']."','".$_POST['Confirm_Password']."')";
