...
$q="select * from v_signup where Type='Rajasthani'";
...
echo "<td><a href='dlunch1.php?id=".$row['Username']."'>Lunch</a></td>";
echo "<td><a href='ddinner1.php?id=".$row['Username']."'>Dinner</a></td>";
echo "</tr>";
}
echo "</table>";
mysqli_close($conn);
