	...
	<div class="container" id="container">
		...
		<h1><center>Dinner<center></h1>
			<form action="#" method="post">
                ...
                <input id="Accesories" name="Accesories" placeholder="Accesories"/>
...
if(isset($_POST['submit']))
{
	...
	$q="insert into lunch(Username,Tiffin_Type,Meal_Type,Bread,Subji1,Subji2,Rice,Dal,Accesories) VALUES ('$uid','".$_POST['Tiffin_Type']."','".$_POST['Meal_Type']."','".$_POST['Bread']."','".$_POST['Subji1']."','".$_POST['Subji2']."','".$_POST['Rice']."','".$_POST['Dal']."','".$_POST['Accesories']."')";
